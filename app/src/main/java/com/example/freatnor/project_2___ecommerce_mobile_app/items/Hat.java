...
public class Hat extends Armor {
    ...
    public Hat(String description, String name, int price, ItemQuality itemQuality, int defense, int magicDefense, int magicAttack, String specialAbility, int imageId) {
    ...
    public Hat(String description, String name, int price, ItemQuality itemQuality, boolean owned,
               int defense, int magicDefense, int magicAttack, String specialAbility, int imageId) {
